...
int main(int argc, char *argv[]) {
  ...
  if (argc > 1 && strcmp(argv[1], "-b") == 0) {
    ...
    std::cout << "Download Bosch simulator from https://github.com/udacity/Bosch-Challenge/releases\n";
  }
  else {
    std::cout << "\nLoading ../data/highway_map.csv\n";
    std::cout << "Download Udacity simulator from https://github.com/udacity/self-driving-car-sim/releases\n";
    std::cout << "Find \"Term 3 Simulator\" there.\n";
    std::cout << "To load Bosch data, run with -b\n";
  }
