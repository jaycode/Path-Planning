    ...
    if (length && length > 2 && data[0] == '4' && data[1] == '2') {
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          // Current car state. Keep them so we can convert to global coordinates.
          double ref_x = car_x;
          double ref_y = car_y;
          ...
          if (previous_path_x.size() < 2) {
            ...
            // rear wheels.
            double prev_car_x = ref_x - car_length * cos(ref_yaw);
            double prev_car_y = ref_y - car_length * sin(ref_yaw);
          ...
          for (int i = 0; i < steps; ++i) {
            next_x_vals.push_back(ref_x + ((i*dt*mph2mps(ref_v)) * cos(ref_yaw)));
            next_y_vals.push_back(ref_y + ((i*dt*mph2mps(ref_v)) * sin(ref_yaw)));
          }
